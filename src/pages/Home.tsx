          ...
          <div className="space-x-2 flex items-center p-2" >
            ...
            <button className="bg-gray-800 text-white rounded-lg hover:bg-[#9FE722] transition-colors duration-1500 w-[150px] h-[50px] flex items-center justify-around cursor-pointer font-semibold">
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-8 p-3">
                ...
                <div className="bg-white rounded-lg shadow-lg shadow-gray-600 w-[392px] h-[336px] px-6 py-4 border border-gray-200">
                  <div className="grid grid-cols-2 text-gray-500 text-sm mb-2">
                    <div>
                  ...
                  <div className="text-gray-500 text-sm mb-4 pb-20">
